package com.lewish.start.notificationdemo.activity;
...
import com.lewish.start.notificationdemo.R;
import com.lewish.start.notificationdemo.base.BaseActivity;
import com.lewish.start.notificationdemo.tools.BaseTools;

public class CustomActivity extends BaseActivity implements OnClickListener{
	/** TAG */
	private final static String TAG = "com.lewish.start.notificationdemo.activity.CustomActivity";
	/** 按钮：显示自定义通知 */
